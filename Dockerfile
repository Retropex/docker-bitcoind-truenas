...
ARG TARGETARCH
ARG ARCH
ARG VERSION=29.2.knots20251110+bip110-v0.1rc3
ARG BITCOIN_CORE_SIGNATURE=2B97F03293744D70F6BBA82F2E3A66FF67F98B4F
...
RUN case ${TARGETARCH:-amd64} in \
    ...
    *) echo "Dockerfile does not support this platform"; exit 1 ;; \
    ...
    && wget -q --show-progress --progress=dot:giga https://github.com/dathonohm/bitcoin/releases/download/v29.2.knots20251110%2Bbip110-v0.1rc3/SHA256SUMS.asc \
            https://github.com/dathonohm/bitcoin/releases/download/v29.2.knots20251110%2Bbip110-v0.1rc3/SHA256SUMS \
            https://github.com/dathonohm/bitcoin/releases/download/v29.2.knots20251110%2Bbip110-v0.1rc3/bitcoin-29.2.knots20251110+bip110-v0.1rc3-${ARCH}-linux-gnu.tar.gz \
